...
class AXILiteInsertSort (val LITE_ADDR_WIDTH: Int = 40, val LITE_DATA_WIDTH: Int = 32) extends BlackBox with HasBlackBoxResource {
  ...
  addResource("/axi_lite_insertSort.v")
  addResource("/insertSort.v")
}

class AXILiteWrapperInsertSort(val LITE_ADDR_WIDTH: Int = 40, val LITE_DATA_WIDTH: Int = 32) extends Module {
  val io = IO(new Bundle {
    val S_AXI_ARESETN = Input(Bool())
  ...
  val axiLite = Module(new AXILiteInsertSort(LITE_ADDR_WIDTH = 40, LITE_DATA_WIDTH = 32))
